    ...
    public function departmentStaffDetails(string $site_slug, string $department_slug, string $uid)
    {
        ...
        return response()->json([
            ...
            'member' => [
                ...
                // grouped by type (journal / conference / other/'journal', 'conference', 'seminar', 'book_chapter')
                'publications' => [
                    'journal'      => $groupedPublications->get('journal', collect())->values(),
                    'conference'   => $groupedPublications->get('conference', collect())->values(),
                    'seminar'      => $groupedPublications->get('seminar', collect())->values(),
                    'book_chapter' => $groupedPublications->get('book_chapter', collect())->values(),
