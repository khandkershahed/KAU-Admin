...
class AcademicContentController extends Controller
{
    ...
    public function storePage(Request $request)
    {
        ...
        $is_department_boxes = $request->boolean('is_department_boxes');
        if ($is_department_boxes) {
            AcademicPage::where('academic_site_id', $siteId)->update(['is_department_boxes' => false]);
        }
        ...
        AcademicPage::create([
            ...
            'is_home'             => $isHome,
            'is_department_boxes' => $is_department_boxes,
    ...
    public function updatePage(Request $request, AcademicPage $page)
    {
        ...
        $is_department_boxes = $request->boolean('is_department_boxes');
        if ($is_department_boxes && !$page->is_department_boxes) {
            AcademicPage::where('academic_site_id', $page->academic_site_id)->update(['is_department_boxes' => false]);
        }
        ...
        $page->is_home             = $isHome;
        $page->is_department_boxes = $is_department_boxes;
