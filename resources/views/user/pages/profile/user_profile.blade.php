    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <!--begin::Navbar-->
                @include('user.pages.profile.top_navbar')
                <!--end::Navbar-->
                    ...
                    <div class="card-body p-9">
                        ...
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-8 d-flex align-items-center">
                                <span class="fw-bolder fs-6 text-gray-800 me-2">{{ $userData->phone }}</span>
                        ...
                        <div class="row mb-7">
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-8">
                                <span class="fw-bolder fs-6 text-gray-800">{{ $userData->address }}</span>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
