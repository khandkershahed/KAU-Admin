                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-center flex-column py-5">
                        ...
                        <div class="symbol symbol-100px symbol-circle mb-7">
                            ...
                            <img src="{{ !empty($user->photo) && file_exists(public_path('storage/' . $user->photo)) ? asset('storage/' . $user->photo) : asset('https://ui-avatars.com/api/?name=' . urlencode($user->name)) }}"
                                alt="{{ $user->name }}" />
                        </div>
        ...
        <div class="flex-lg-row-fluid ms-lg-15">
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade show active" id="kt_user_view_overview_tab" role="tabpanel">
                    @include('admin.pages.staff.partials.update-profile-information-form')
                </div>


                <div class="tab-pane fade" id="kt_user_view_overview_security" role="tabpanel">

                    @include('admin.pages.staff.partials.update-password-form')
                ...
                <div class="tab-pane fade" id="kt_user_view_overview_events_and_logs_tab" role="tabpanel">
                    ...
                    @include('admin.pages.staff.partials.delete-user-form')
