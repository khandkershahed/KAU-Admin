<x-admin-app-layout :title="'Create Seat Type'">
    <div class="card card-flash">
        ...
        <div class="card-body pt-0">
            <form method="POST" action="{{ route('admin.event-seat-type.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-7">
                        ...
                        <x-metronic.input id="name" type="text" name="name"
                            placeholder="Enter seat type name" :value="old('name')" required />
                    </div>
                    ...
                    <div class="col-lg-6 mb-7">
                        ...
                        <x-metronic.input id="code" type="text" name="code"
                            placeholder="Enter seat type code" :value="old('code')" />
                    </div>
                    ...
                    <div class="col-lg-12 mb-7">
                        ...
                        <x-metronic.textarea id="description" name="description"
                            placeholder="Write short description...">{{ old('description') }}</x-metronic.textarea>
                    </div>
                </div>
