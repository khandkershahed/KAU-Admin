<x-admin-app-layout :title="'Bulk Row Add Publications'">
    <div class="card shadow-sm">
        <div class="card-header d-flex align-items-center justify-content-between">
            <div>
                <h3 class="card-title fw-bold mb-0">Bulk Row wise Add Publications</h3>
        ...
        <div class="card-body">
            <form action="{{ route('admin.academic.publications.bulk-row-store', $member->id) }}" method="POST" novalidate>
                @csrf
