<x-admin-app-layout :title="'Edit Staff Member'">
    <div class="card shadow-sm">
        ...
        <form action="{{ route('admin.academic.staff-members.update', $member->id) }}" method="POST"
            ...
            <div class="card-body px-7">
                ...
                <div class="tab-content">
                            ...
                            <div class="col-md-3">
                                ...
                                @if ($member->image_path)
                                    <div class="mt-3">
                                        ...
                                        <img src="{{ asset('storage/' . $member->image_path) }}" class="rounded-circle"
                            ...
                            <div class="col-md-9">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-4">
                                        <label class="form-label fw-semibold text-black">Name <span
                                                class="text-danger">*</span></label>
                                        <input type="text" class="form-control form-control-sm" name="name"
                                            id="editMemberName" value="{{ old('name', $member->name) }}" required>
                                    </div>
                                    ...
                                    <div class="col-md-3 mb-4">
                                        ...
                                        <input type="text" class="form-control form-control-sm" name="email"
                                            id="editMemberEmail" value="{{ old('email', $member->email) }}">
                                    </div>
                                    ...
                                    <div class="col-md-3 mb-4">
                                        ...
                                        <input type="text" class="form-control form-control-sm" name="mobile"
                                            id="editMemberMobile" value="{{ old('mobile', $member->mobile) }}">
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control" name="address" id="editMemberAddress" rows="2">{{ old('address', $member->address) }}</textarea>
                                    </div>
                                            ...
                                            @if (!empty($links))
                                                @foreach ($links as $i => $l)
                                                    <div class="row g-3 link-row mb-2">
                                                        ...
                                                        <div class="col-md-6">
                                                            <label
                                                                class="form-label fw-semibold text-black">URL</label>
                                                            <input type="text"
                                                                name="links[{{ $i }}][url]"
                                                                class="form-control" value="{{ $l['url'] ?? '' }}"
                                            ...
                                            @else
                                                <div class="row g-3 link-row mb-2">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" name="links[0][url]"
                        ...
                        <div class="row g-4">
                            <div class="col-md-12">
                                <x-metronic.editor id="edit_member_bio" name="bio" label="Bio"
                                    :value="old('bio', $member->bio)" rows="7" />
                            </div>

                            <div class="col-md-12">
                                <label class="form-label fw-semibold text-black">Research Interest</label>
                                <textarea class="form-control" name="research_interest" id="editMemberResearchInterest" rows="3">{{ old('research_interest', $member->research_interest) }}</textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row g-4">
                            <div class="col-md-12">
                                <x-metronic.editor id="edit_member_education" name="education" label="Education"
                                    :value="old('education', $member->education)" rows="7" />
                            </div>

                            <div class="col-md-12">
                                <x-metronic.editor id="edit_member_experience" name="experience" label="Experience"
                                    :value="old('experience', $member->experience)" rows="7" />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row g-4">
                            <div class="col-md-12">
                                <x-metronic.editor id="edit_member_employment_history" name="employment_history"
                                    label="Employment History" :value="old('employment_history', $member->employment_history)" rows="3" />
                            </div>
                            <div class="col-md-12">
                                <x-metronic.editor id="edit_member_institutional_member" name="institutional_member"
                                    label="Institutional Member" :value="old('institutional_member', $member->institutional_member)" rows="3" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tab-pane fade" id="edit_tab_research" role="tabpanel">
                        <div class="row g-4">
                            <div class="col-md-12">
                                <x-metronic.editor id="edit_member_consultancy" name="consultancy"
                                    label="Consultancy" :value="old('consultancy', $member->consultancy)" rows="3" />
                            </div>
                            <div class="col-md-12">
                                <x-metronic.editor id="edit_member_research" name="research"
                                    label="Founded Research Project" :value="old('research', $member->research)" rows="3" />
                            </div>
                        </div>
                    </div>
