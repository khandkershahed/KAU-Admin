<x-admin-app-layout :title="'Add Academic Menu Group'">
    <div class="card shadow-sm">
        <div class="card-header d-flex align-items-center justify-content-between">
            <h3 class="card-title fw-bold mb-0">Add Menu Group</h3>
        ...
        <div class="card-body">
            <form action="{{ route('admin.academic.groups.store') }}" method="POST" novalidate>
                @csrf
                ...
                <div class="row g-4">
                    <div class="col-md-8">
                        ...
                        <input type="text" name="title" class="form-control form-control-sm" value="{{ old('title') }}"
                            placeholder="Faculty of ... / Menu group title" required>
                    </div>
