                        ...
                        <div id="staffLinksRepeater">
                            ...
                            <div class="row g-3 link-row mb-2">
                                <div class="col-md-4">
                                    ...
                                    <x-icon-picker name="links[0][icon]" />
                                </div>
                                <div class="col-md-6">
        ...
        <form class="modal-content" method="POST" enctype="multipart/form-data" id="editStaffMemberForm">
            ...
            <div class="modal-body">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-4">
                        <label class="form-label fw-semibold">Image</label>
                        <x-image-picker name="image" id="editMemberImagePicker" />
                    </div>

                    <div class="col-md-4">
                        <label class="form-label fw-semibold">Name</label>
                        <input type="text" class="form-control slug-source-edit" name="name" id="editMemberName">
                    </div>
