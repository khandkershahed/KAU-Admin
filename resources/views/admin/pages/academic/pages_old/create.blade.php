    ...
    <div class="card">
        <div class="card-header align-items-center">
            ...
            <div class="d-flex gap-2">
                ...
                @if ($selectedSite)
                    <button type="submit" form="academicPageCreateForm" class="btn btn-primary btn-sm">
        ...
        <div class="card-body">
            ...
            @else
                <form id="academicPageCreateForm" method="POST" action="{{ route('admin.academic.pages.store') }}" enctype="multipart/form-data">
                    @csrf
