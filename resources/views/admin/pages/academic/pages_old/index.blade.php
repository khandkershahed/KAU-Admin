            ...
            @else
                <div class="d-flex align-items-center justify-content-between my-4">
                    <div>
                        ...
                        <div class="text-muted small">Manage pages for: <span
                                class="fw-semibold">{{ $selectedSite->name }}</span></div>
                    </div>
                ...
                <ul class="list-group" id="pageSortableWrapper">
                    @forelse($pages as $page)
                        <li class="list-group-item py-5 my-2 d-flex align-items-center justify-content-between"
                            ...
                            <div class="d-flex align-items-center">
                                @can('edit academic pages')
                                    <label class="form-check form-switch form-switch-sm me-3">
                                        <input type="checkbox" class="form-check-input toggleAcademicPageStatus"
                                            data-id="{{ $page->id }}"
                            ...
                            <div class="d-flex align-items-center">
                                @can('edit academic pages')
                                    <a href="{{ route('admin.academic.pages.edit', $page->id) }}"
                                        class="me-5 text-decoration-none">
                                        <i class="fa fa-pen-to-square fs-4 text-info"></i>
                                    </a>
                                @endcan
