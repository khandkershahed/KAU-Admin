            ...
            <div class="card-toolbar d-flex">
                ...
                <div class="row g-2 me-4">
                    ...
                    <div class="col">
                        ...
                        <x-metronic.select-option id="aboutStatusFilter" class="form-select-sm"
                    ...
                    <div class="accordion-header d-flex align-items-center justify-content-between px-3 py-2"
                        ...
                        <div class="d-flex align-items-center flex-grow-1">
                            ...
                            <button class="accordion-button py-2 px-2 shadow-none bg-transparent flex-grow-1"
                                    ...
                                    data-bs-target="#about-pages-body">
                    ...
                    fetch(url, {
                        ...
                        .then(json => {
                            if (json.success) {
                                ...
                                Swal.fire('Error', json.message || 'Failed to update featured status.', 'error');
                            }
                        })
                        .catch(() => {
                            checkbox.checked = !isFeatured;
