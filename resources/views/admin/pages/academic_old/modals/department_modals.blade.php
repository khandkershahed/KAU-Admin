...
<div class="modal fade" id="createDepartmentModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <form class="modal-content" method="POST" action="{{ route('admin.academic.departments.store') }}">
            @csrf
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text"
                               name="slug"
                               id="deptCreateSlug"
                               class="form-control slug-target"
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text"
                               name="slug"
                               id="deptEditSlug"
                               class="form-control slug-target-edit">
                    </div>
