                ...
                @foreach($weekDays as $key => $label)
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <input type="checkbox"
                                   class="form-check-input toggle-closed"
                                   data-day="{{ $key }}"
    ...
    document.addEventListener('DOMContentLoaded', function () {
        document.querySelectorAll('.toggle-closed').forEach(function (checkbox) {
            checkbox.addEventListener('change', function () {
                ...
                var startInput = row.querySelector('input[name="business_hours[' + day + '][start]"]');
                var endInput = row.querySelector('input[name="business_hours[' + day + '][end]"]');
