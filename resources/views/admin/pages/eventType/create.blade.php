<x-admin-app-layout :title="'Event Type Create'">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-7">
                        ...
                        <x-metronic.input id="name" type="text" name="name"
                            placeholder="Enter the Event Type name" :value="old('name')" required></x-metronic.input>
                    </div>
                    ...
                    <div class="col-lg-3 mb-7">
                        ...
                        <x-metronic.input id="code" type="text" name="code"
                            placeholder="Enter code (optional)" :value="old('code')"></x-metronic.input>
                    </div>
                    ...
                    <div class="col-lg-3 mb-7">
                        ...
                        <x-metronic.input id="serial" type="text" name="serial"
                            placeholder="Enter serial (optional)" :value="old('serial')"></x-metronic.input>
                    </div>
                    ...
                    <div class="col-lg-9 mb-7">
                        ...
                        <x-metronic.textarea id="description" name="description"
                            placeholder="Enter description (optional)">{{ old('description') }}</x-metronic.textarea>
                    </div>
