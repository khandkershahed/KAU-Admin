    ...
    <div class="card">
        <div class="card-header align-items-center">
            ...
            <div class="d-flex gap-2">
                <a href="{{ route('admin.cms.main.menu.index', ['menu_location' => 'navbar']) }}" class="btn btn-sm {{ $location === 'navbar' ? 'btn-primary' : 'btn-light' }}">Navbar</a>
                <a href="{{ route('admin.cms.main.menu.index', ['menu_location' => 'topbar']) }}" class="btn btn-sm {{ $location === 'topbar' ? 'btn-primary' : 'btn-light' }}">Topbar</a>

                <a href="{{ route('admin.cms.main.menu.create', ['menu_location' => $location]) }}" class="btn btn-dark btn-sm">
        ...
        <div class="card-body">
            ...
            <ul class="list-group menu-sortable" id="mainMenuRoot" data-parent="">
                @foreach($roots as $root)
                    @include('admin.pages.cms.main.menu.partials.item', ['item' => $root, 'byParent' => $byParent, 'location' => $location])
                @endforeach
            </ul>
