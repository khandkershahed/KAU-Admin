...
<li class="menu-li mb-2" data-id="{{ $item->id }}">

    <div class="list-group-item d-flex align-items-center justify-content-between menu-item-row">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('admin.cms.main.menu.edit', ['item' => $item->id, 'menu_location' => $location]) }}"
               class="btn btn-light-success btn-sm">
                <i class="fa-solid fa-pen-to-square"></i>
            </a>
            <a href="{{ route('admin.cms.main.menu.destroy', ['item' => $item->id]) }}"
               class="btn btn-light-danger btn-sm delete-main-menu">
    ...
    @if($children->count())
        <div class="pt-0">
            <ul class="list-group ms-10 menu-sortable mt-2" data-parent="{{ $item->id }}">
