            ...
            <div class="card-body">
                    ...
                    <select name="nav_item_id" class="form-select form-select-sm" required>
                        ...
                        @foreach($navItems as $item)
                            <option value="{{ $item->id }}" @selected(old('nav_item_id', $page->nav_item_id ?? '') == $item->id)>
                                {{ $item->label }}  (/page/{{ $item->slug }})
                            </option>
                        @endforeach
                    </select>
                    <div class="form-text">
                        Create the menu item first: <strong>Main CMS → Menu</strong> → type <code>page</code>.
                        This page will render at: <code>/page/[slug]</code>.
                        If you mark it as <code>Home</code>, it becomes <code>/</code>.
                    </div>
                </div>
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        ...
                        <div class="form-text">Next.js can switch layouts based on template_key.</div>
                    </div>
                ...
                <div class="d-flex align-items-center mt-6">
                    <label class="form-check form-switch form-check-custom form-check-solid">
                        ...
                        <span class="form-check-label fw-semibold">Home Page</span>
                    </label>
                    <div class="text-muted ms-4">
                        If enabled, this page will render on <code>/</code>.
                    </div>
                </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <x-metronic.image-input name="banner_image" id="mainPageBannerImage"
    ...
    <div class="col-lg-4">
        <div class="card mb-6">
            ...
            <div class="card-body">
                ...
                <x-metronic.image-input name="og_image" id="mainPageOgImage"
