<x-admin-app-layout :title="'Events'">

    <div class="card card-flush shadow-sm">
        <div class="card-header align-items-center py-5">
            <div class="d-flex flex-column flex-md-row justify-content-between w-100 align-items-md-center gap-3">
                <div>
                    <h3 class="card-title fw-bold mb-1">Events</h3>
                    <span class="text-muted fs-7">Manage university events (list, publish, archive).</span>
                </div>
        ...
        <div class="card-body pt-0">
            <div class="row g-3 align-items-end mb-6">
                <div class="col-md-5">
                    ...
                    <x-metronic.input id="q" name="q" type="text" :value="$search" placeholder="Title / Venue / Organizer" />
                </div>
            ...
            <div id="table_container">
                @include('admin.pages.events.partials.table', ['events' => $events, 'search' => $search, 'status' => $status])
            </div>
        </div>
    </div>
        ...
        <script>
            (function () {
                ...
                const buildUrl = (pageUrl) => {
                    const base = pageUrl || "{{ route('admin.events.index') }}";
