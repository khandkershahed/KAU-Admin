    ...
    <div class="card card-flush shadow-sm">
        <div class="card-header align-items-center py-5">
            <div class="d-flex flex-column flex-md-row justify-content-between w-100 align-items-md-center gap-3">
                <div>
                    <h3 class="card-title fw-bold mb-1">Create Event</h3>
                    <span class="text-muted fs-7">Add a new event with schedule, content and attachments.</span>
                </div>
        ...
        <div class="card-body pt-0">
            ...
            <form method="POST" action="{{ route('admin.events.store') }}" enctype="multipart/form-data">
                @csrf
                @include('admin.pages.events._form')
            </form>
        </div>
    </div>
