                        ...
                        <div class="tab-content">
                                    ...
                                    <div class="card-body pt-4">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 mb-6">
                                                ...
                                                <x-metronic.input id="title" type="text" name="title" :value="old('title',$notice->title)" required />
                                            </div>
                                            ...
                                            <div class="col-lg-4 mb-6">
                                                ...
                                                <x-metronic.input id="publish_date" type="date" name="publish_date" :value="old('publish_date',$notice->publish_date)" />
                                            </div>
                                            ...
                                            <div class="col-lg-4 mb-6">
                                                ...
                                                <x-metronic.select-option id="is_featured" name="is_featured" data-hide-search="true">
                                                    <option value="0" {{ old('is_featured', (string)$notice->is_featured) === '0' ? 'selected' : '' }}>No</option>
                                                    <option value="1" {{ old('is_featured', (string)$notice->is_featured) === '1' ? 'selected' : '' }}>Yes</option>
                                                </x-metronic.select-option>
                                            </div>
                                            ...
                                            <div class="col-lg-4 mb-6">
                                                ...
                                                <x-metronic.select-option id="status" name="status" data-hide-search="true">
                                                    ...
                                                    <option value="archived" {{ old('status', $notice->status) === 'archived' ? 'selected' : '' }}>
                                                        Archived
                                                    </option>
                                                </x-metronic.select-option>
                                            </div>
                                            ...
                                            <div id="table_fields_wrap" class="col-12" style="display:none;">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-4 mb-6">
                                                        ...
                                                        <x-metronic.input id="employee_name" type="text" name="employee_name" :value="old('employee_name', $notice->employee_name)" />
                                                    </div>
                                                    ...
                                                    <div class="col-lg-4 mb-6">
                                                        ...
                                                        <x-metronic.input id="designation" type="text" name="designation" :value="old('designation', $notice->designation)" />
                                                    </div>
                                                    ...
                                                    <div class="col-lg-4 mb-6">
                                                        ...
                                                        <x-metronic.input id="department" type="text" name="department" :value="old('department', $notice->department)" />
                                                    </div>
                                                </div>
                                            </div>
                                            {{-- /TABLE VIEW EXTRA FIELDS --}}
                            ...
                            <div class="tab-pane fade" id="tab_content" role="tab-panel">
                                <div class="card card-flush border rounded-3 shadow-none mb-6">
                                    ...
                                    <div class="card-body pt-4">
                                        <x-metronic.editor name="body" label="Notice Content" :value="old('body', $notice->body)" rows="12" />
                                                ...
                                                <div class="d-flex flex-wrap gap-3">
                                                    @foreach ($existingAttachments as $path)
                                                        @php
                                                            ...
                                                            $url = $pathStr ? asset('storage/' . ltrim($pathStr, '/')) : '#';
                                                        @endphp
                                                        ...
                                                        <div class="border rounded-3 p-3 bg-light" style="min-width: 220px;">
                                                            ...
                                                            <a href="{{ $url }}" target="_blank" class="btn btn-sm btn-light-primary w-100">
                                                                View / Download
                                                            </a>
                                                        </div>
                                                    @endforeach
                                ...
                                <div class="card card-flush border rounded-3 shadow-none mb-6">
                                    ...
                                    <div class="card-body pt-4 row">
                                        <div class="col-lg-5 mb-6">
                                            ...
                                            <x-metronic.input id="meta_title" type="text" name="meta_title" :value="old('meta_title', $notice->meta_title)" />
                                        </div>
                                        ...
                                        <div class="col-lg-7 mb-6">
                                            ...
                                            <x-metronic.input id="meta_tags" type="text" name="meta_tags" :value="old('meta_tags', $notice->meta_tags)" placeholder="notice, admission,.." />
                                        </div>
                                        ...
                                        <div class="col-lg-12 mb-6">
                                            ...
                                            <x-metronic.textarea id="meta_description" name="meta_description" placeholder="Short description">{{ old('meta_description', $notice->meta_description) }}</x-metronic.textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
