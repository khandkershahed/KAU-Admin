                ...
                <tr>
                    ...
                    <td class="text-end">
                        @can('edit notice category')
                            <button type="button" class="btn btn-icon btn-light-success btn-sm editCategoryBtn"
                                data-id="{{ $category->id }}" data-name="{{ $category->name }}" data-viewtype="{{ $category->view_type ?? 'page' }}"
