<x-admin-app-layout :title="'Edit Administration Group'">
    <div class="card shadow-sm">
        <div class="card-header d-flex align-items-center justify-content-between">
            <h3 class="card-title fw-bold mb-0">Edit Group</h3>
        ...
        <div class="card-body">
            <form action="{{ route('admin.administration.group.update') }}" method="POST" novalidate>
                @csrf
