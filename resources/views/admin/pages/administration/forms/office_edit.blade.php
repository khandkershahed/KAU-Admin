<x-admin-app-layout :title="'Edit Administration Office'">
    <div class="card shadow-sm">
        <div class="card-header d-flex align-items-center justify-content-between">
            <h3 class="card-title fw-bold mb-0">Edit Office</h3>
        ...
        <div class="card-body">
            <form action="{{ route('admin.administration.office.update') }}" method="POST" novalidate>
                @csrf
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="title" class="form-control form-control-sm"
                            value="{{ old('title', $office->title) }}" placeholder="Enter office title..." required>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="group_id" class="form-select form-select-sm" required>
                            ...
                            @foreach ($groups as $g)
                                <option value="{{ $g->id }}"
                                    @if (old('group_id', $office->group_id) == $g->id) selected @endif>
                                    {{ $g->name }}
                                </option>
                            @endforeach
                        </select>
